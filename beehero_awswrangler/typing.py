...
class AthenaCacheSettings(TypedDict):
    ...
    """
    beehero_awswrangler can look up in Athena's history if this table has been read before.
    If so, and its completion time is less than `max_cache_seconds` before now, beehero_awswrangler
