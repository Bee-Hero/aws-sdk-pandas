...
from beehero_awswrangler import _data_types, _utils, catalog, exceptions, typing
from beehero_awswrangler._config import apply_configs
from beehero_awswrangler._distributed import engine
from beehero_awswrangler._utils import copy_df_shallow
from beehero_awswrangler.s3._delete import delete_objects
from beehero_awswrangler.s3._fs import open_s3_object
from beehero_awswrangler.s3._write import _COMPRESSION_2_EXT, _apply_dtype, _sanitize, _validate_args
from beehero_awswrangler.s3._write_dataset import _to_dataset
from beehero_awswrangler.typing import BucketingInfoTuple, GlueTableSettings, _S3WriteDataReturnValue
    ...
    **pandas_kwargs: Any,
    ...
    if "pandas_kwargs" in pandas_kwargs:
        raise exceptions.InvalidArgument(
            ...
            "Pandas arguments in the function call and beehero_awswrangler will accept it."
